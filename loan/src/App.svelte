...
<input type="number" name="loan" id="loan" bind:value={loanAmount}>

<label for="interest">Interest Rate</label>
<input type="number" name="interest" id="interest" bind:value={interestRate}>

<label for="years">Years</label>
<input type="number" name="years" id="years" bind:value={years}>
